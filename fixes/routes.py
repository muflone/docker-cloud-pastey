...
# Set badwords list
config.badwords = environ["PASTEY_BADWORDS"].split(",") if "PASTEY_BADWORDS" in environ else []
...
def paste():
    ...
    # Check for badwords in content
    for badword in config.badwords:
        if badword in content.casefold():
            abort(400)
